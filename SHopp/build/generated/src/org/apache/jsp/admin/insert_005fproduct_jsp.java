...
public final class insert_005fproduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \n");
      out.write("        <title>Thêm hóa đơn</title>\n");
      out.write("\n");
      out.write("        ");
 ...
 CategoryDAO caedao=new CategoryDAO();
      ...
      out.write("                                <input type=\"number\" class=\"sedang\" name=\"id\"></td></tr>\n");
      out.write("                        <tr><td><b>Tên sản phẩm</b></td><td>\n");
      out.write("                                <input type=\"text\" class=\"sedang\" name=\"name\"></td></tr>\n");
      out.write("                        <tr><td><b>Số Lượng</b></td><td>\n");
      out.write("                                <input type=\"number\" class=\"form-control\" placeholder=\"Enter Quantity\" name=\"quantity\" class=\"sedang\" ></td></tr>\n");
      out.write("                        <tr><td><b>Giá bán</b></td><td>\n");
      out.write("                                <input type=\"text\" class=\"sedang\" name=\"price\"></td></tr>\n");
      out.write("<!--                        <tr><td><b>Ngày Sản Xuất</b></td><td>\n");
      out.write("                                <input type=\"date\" class=\"form-control\" placeholder=\"Enter Publishday:\" name=\"publishday\" class=\"sedang\" ></td></tr>-->\n");
      out.write("                        <tr><td><b>Loại sản phẩm</b></td><td>\n");
      out.write("                                <select name=\"idDanhMuc\">\n");
      out.write("                                    <option selected>-- chọn loại sản phẩm --</option>\n");
      out.write("                                ");
 for (int i = 0; i < caedao.getAllSanPhamCombo().size(); i++) {
      out.write("\n");
      out.write("                                \n");
      out.write("                                <option value=\"");
      out.print(caedao.getAllSanPhamCombo().get(i).getCategoryID());
      out.write('"');
      out.write('>');
      out.print(caedao.getAllSanPhamCombo().get(i).getCategoryName());
      out.write("</option>\n");
      out.write("                                    \n");
      out.write("                                \n");
      out.write("                                \n");
      ...
      out.write("                            <td>\n");
      out.write("                                <textarea class=\"form-textarea\" id=\"noiDung\"> null</textarea>\n");
      out.write("                                <script type=\"text/javascript\" language=\"javascript\">\n");
      out.write("                                   CKEDITOR.replace('noiDung', {width: '500px',height: '300px'});\n");
      out.write("                                </script>\n");
      out.write("                            </td>\n");
      out.write("                        </tr>\n");
      out.write("                        <tr><td></td><td>\n");
      out.write("                                <input type=\"hidden\" class=\"button\" name=\"action\" value=\"add\">\n");
